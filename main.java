...
class BarangaySystem {
    ...
    // UPDATED: Name + Birthdate + Auto Age Change
    public void updateResident(String name, Scanner sc) {
        ...
        System.out.println("6. Update Birthdate");  // NEW
        ...
        switch (choice) {
            ...
            case 5: // UPDATE NAME
                ...
                if (isDuplicate(newName, r.getBirthdate())) {
                    System.out.println("Duplicate name with same birthdate FOUND. Name not updated.");
                    return;
                }

                Resident updatedNameObj = categorize(
                        newName,
                        r.getBirthdate(),
                        r.getGender(),
                        r.getHouseNumber(),
                ...
                records.remove(r);
                records.add(updatedNameObj);

                System.out.println("Name updated successfully!");
                break;

            case 6: // UPDATE BIRTHDATE + AUTO AGE + AUTO CATEGORY
                System.out.print("Enter new birthdate (YYYY-MM-DD): ");
                String newBirthdate = sc.nextLine();

                Resident updatedBirthObj = categorize(
                        r.getName(),
                        newBirthdate,
                        r.getGender(),
                        r.getHouseNumber(),
                ...
                records.remove(r);
                records.add(updatedBirthObj);

                System.out.println("Birthdate updated successfully!");
                System.out.println("Age & Category recalculated automatically.");
                break;
